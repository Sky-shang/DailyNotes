    ...
    <table style="height: 580px; width: 778px; font-size: 9pt" align="center" cellspacing="0" background="Image/新闻发布系统二级页.jpg">
        ...
        <tr style="width: 778px; height: 38px">
            <td colspan="2" style="height: 19px; font-size: 9pt" valign="middle">&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;
                     <asp:Image ID="imageTitle" runat="server" Height="19px" ImageUrl="~/Image/二级页时政要闻.jpg" Width="486px" />
            </td>
        </tr>
        <tr style="width: 778px; height: 504px">
            <td align="center" style="width: 178px; height: 154px" valign="top">
                <asp:Image ID="imageLag" runat="server" Height="79px" ImageUrl="~/Image/图片时政要闻.jpg" Width="86px" />
            </td>
