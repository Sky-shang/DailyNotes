<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="DailyNotes.LoginFunction.Register" %>
                ...
                <td style="height: 203px">
                    <table style="font-size: 9pt; width: 367px; height: 136px">
                        ...
                        <tr style="color: #000000; text-decoration: underline">
                            <td style="width: 62px; height: 28px">密码：</td>
                            ...
                            <td style="width: 164px; height: 28px" align="left"></td>
                        </tr>
                        <tr>
                            <td style="width: 62px">确认密码：</td>
                            <td style="width: 114px">
                        ...
                        <tr>
                            <td style="width: 62px; height: 26px">Email：</td>
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="color: red; height: 15px">以上内容为必填项，请正确填写，否则无法完成注册！</td>
                        </tr>
                        <tr>
